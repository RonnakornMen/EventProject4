...
public class PlasticGlass{
    ...
    public PlasticGlass(final World world,final float x_px, final float y_px) {

        sprite = SpriteLoader.getSprite("images/trash/plasticGlass.json");
